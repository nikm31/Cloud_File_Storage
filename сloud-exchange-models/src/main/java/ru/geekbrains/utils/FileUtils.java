...
public class FileUtils {
    ...
    public static int PACKAGE_SIZE = 41943040;

    public void sendFileByParts(Path path, Channel channel, long offset) throws IOException {
    ...
    public void savePart(Path path, byte[] data) {
        try {
